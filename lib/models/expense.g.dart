...
class Expense extends $Expense with RealmEntity, RealmObjectBase, RealmObject {
  ...
  static SchemaObject _initSchema() {
    ...
    return  SchemaObject(ObjectType.realmObject, Expense, 'Expense', [
      ...
      const SchemaProperty('date', RealmPropertyType.timestamp),
      const SchemaProperty('note', RealmPropertyType.string, optional: true),
      const SchemaProperty('recurrence', RealmPropertyType.string, optional: true),
    ]);
  }
}
